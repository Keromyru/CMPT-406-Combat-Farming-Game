...
public class ProjectilePlayerOnAttackSO : PlayerOnAttackSO
{
    public override void OnAttack(float damage, Vector2 targetLocation, GameObject thisObject){
      ...
      Vector3 tLocation = new Vector3(targetLocation.x,targetLocation.y,0); //Target Location
      ...
      GameObject projectile = Instantiate(projectilePrefab, trackedLocation, Quaternion.Euler(trackedRotation.x,trackedRotation.y,trackedRotation.z));
