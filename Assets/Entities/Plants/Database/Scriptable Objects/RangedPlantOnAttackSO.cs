...
[CreateAssetMenu(fileName = "OnAttack Ranged", menuName = "Plant Data/Plant Action/OnHit Ranged Attack")]
public class RangedPlantOnAttackSO : PlantOnAttackSO
{   
   [SerializeField] float range;
   [SerializeField] float damage;
   
   public override void OnAttack(float damage, GameObject target){
